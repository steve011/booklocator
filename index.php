...
<body>
  ...
  $stid = oci_parse($connection, 'SELECT * FROM (SELET * FROM books ORDER BY DBMS_RANDOM.RANDOM) WHERE ROWNUM <= 5'); /* Added "WHERE ROWNUM <= 1000", takes forever to load otherwise */
  oci_execute($stid);
