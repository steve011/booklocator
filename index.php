			...
			<div class="row" style="">
					...
					<?php
					 ...
					 $array = array();
  					...
  					if(isset($rating['AVERAGE_RATING'])) $_SESSION["$isbn"]['RATING'] = $rating;
					...
					if(isset($rating['AVERAGE_RATING'])) echo '<p style="font-size:12px;text-align:center;"> Average Rating: '.htmlentities($rating['AVERAGE_RATING']).'</p>';
