	...
	<body>	
		...
		<div class="container" style="margin-top:20px;">
			<div class="row" style="">
					...
					<?php
					 $stid = oci_parse($connection, 'SELECT * FROM (SELECT * FROM BOOK ORDER BY DBMS_RANDOM.VALUE()) WHERE ROWNUM <= 5'); /* Added "WHERE ROWNUM <= 1000", takes forever to load otherwise */
					 oci_execute($stid);
