	...
	<body>
		...
		<div class="container" >
			<div class="row" style="padding-top:55px;">
				...
				<div class="col-xs-8" style="background-color:#ff471a;padding-top: 5px;border: 3px solid black;border-radius:5px;float:center;">
					<div class="col-xs-12" style="height:450px;background-color:#1ad2ff;">
						...
						<div style="text-align:left;width:100%;color:white;">
							...
							<h4 style = "text-align: left;"><b>Average User Rating:</b> <?php echo $row['RATING']['AVERAGE_RATING'];?></h4> Out of <?php echo $row['RATING']['NUMBER_OF_RATINGS'];?> users
						</div>
					</div>
				</div>
